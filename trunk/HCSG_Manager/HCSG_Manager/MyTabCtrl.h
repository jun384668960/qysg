...
// Operations
public:
	void SetNumberOfPages(int TabPagesNum);
	void SetCurrentPage(int TabIndex);
	HWND InsetPage(int TabIndex, int PageID, CDialog *PageDlg);
	void SetRectangle(int TabIndex);
