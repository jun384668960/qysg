...
namespace SGCommonHelper
{
    ...
    public class ItemCtrl
    {
        ...
        public bool SaveItemDefInfo()
        {
            ...
            ItemDef_Str[] SortedArray = m_ItemDefList.ToArray();
            Array.Sort(SortedArray
                , (Comparison<ItemDef_Str>)
                delegate(ItemDef_Str a, ItemDef_Str b) 
                { 
                    return int.Parse(a.id) > int.Parse(b.id) ? 1 : int.Parse(a.id) == int.Parse(b.id) ? 0 : -1; 
                });

            m_ItemDefList = new List<ItemDef_Str>(SortedArray);
        ...
        public bool AddItemDef(ItemDef_Str item)
        {
            m_ItemDefList.Add(item);
        ...
        public bool ItemNameHelpRebuild()
        {
