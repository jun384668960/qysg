...
namespace register_client
{
    ...
    public partial class LoginClient : Form
    {
        ...
        private static string serverIp = "119.167.139.137";   //情义
        ...
        private void LoadNews()
        {
            ...
            //share
            lbl_share1.Text = CIniCtrl.ReadIniData("Share1", "text", "", g_versionFile);
            lbl_share1.Links.Add(0, lbl_share1.Text.Length, CIniCtrl.ReadIniData("Share1", "link", "", g_versionFile));
            lbl_shareTime1.Text = CIniCtrl.ReadIniData("Share1", "time", "", g_versionFile);

            lbl_share2.Text = CIniCtrl.ReadIniData("Share2", "text", "", g_versionFile);
            lbl_share2.Links.Add(0, lbl_share2.Text.Length, CIniCtrl.ReadIniData("Share2", "link", "", g_versionFile));
            lbl_shareTime2.Text = CIniCtrl.ReadIniData("Share2", "time", "", g_versionFile);

            lbl_share3.Text = CIniCtrl.ReadIniData("Share3", "text", "", g_versionFile);
            lbl_share3.Links.Add(0, lbl_notic3.Text.Length, CIniCtrl.ReadIniData("Share3", "link", "", g_versionFile));
            lbl_shareTime3.Text = CIniCtrl.ReadIniData("Share3", "time", "", g_versionFile);
        }
        ...
        private void lbl_share1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            lbl_share1.Links[lbl_share1.Links.IndexOf(e.Link)].Visited = true;
            System.Diagnostics.Process.Start(e.Link.LinkData.ToString());
        }
        private void lbl_share2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            lbl_share2.Links[lbl_share2.Links.IndexOf(e.Link)].Visited = true;
            System.Diagnostics.Process.Start(e.Link.LinkData.ToString());
        }
        private void lbl_share3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            lbl_share3.Links[lbl_share3.Links.IndexOf(e.Link)].Visited = true;
            System.Diagnostics.Process.Start(e.Link.LinkData.ToString());
        }
        ...
        private void lbl_offWeb_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {

        }
        private void lbl_newLead_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {

        }
        private void lbl_feature_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void lbl_reChr_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {

        }
        private void lbl_cmServer_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void LoginClient_Shown(object sender, EventArgs e)
        {
            ...
            string Parameter = "rd /s /q data shape Script Update.cab 情义三国.exe";
        ...
        public static void CloseAllGame()
        {
            try
            {
                ...
                var proTmp = System.Diagnostics.Process.GetProcessesByName(g_realStartFile);
                foreach (var itmp in proTmp)
                {
                    itmp.Kill();
                }
                ...
                string fileName = System.Environment.CurrentDirectory + @"\" + g_realStartFile;
        ...
        {
            //查找bb的main.dat进程
            var proTmp = System.Diagnostics.Process.GetProcessesByName("main.dat");
            foreach (var itmp in proTmp)
            {
            ...
            proTmp = System.Diagnostics.Process.GetProcessesByName("" + StartFile);
            if (proTmp.Length > 0)
            {
                online = true;
            }
            if (proTmp.Length <= 0 && online)
            {
                //如果找到，干掉所有的temp.tmp进程兵器杀出temp.tmp文件
                CloseAllGame();
