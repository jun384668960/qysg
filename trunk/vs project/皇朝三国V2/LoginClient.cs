...
namespace register_client
{
    ...
    public partial class LoginClient : Form
    {
        ...
        public static int g_limitNum = 3;                  //正常情况下的多开现在
        public static int g_SpcTimeLimitNum = 3;            //特殊时段多开限制
        ...
        public static long StartFileSize = 11625157L;
        public static bool showStartFileSize = false;
        public static string g_CmdLine = "01 02 03 04 04";
        ...
        private void EnableImageAnimate()
        {
        ...
        {
            base.OnLoad(e);
            m_imgImage = Properties.Resources.窗体背景; // 加载测试用的Gif图片
            BeginAnimate();
        }
        ...
        private void LoginClient_load(object sender, EventArgs e)
        {
            ...
            //Bitmap btm = Properties.Resources.登陆器界面;
            //Bitmap btm = Properties.Resources.test;
            Bitmap btm = Properties.Resources.窗体背景;
            ...
            sp.Stream = Properties.Resources.启动音乐;
            sp.PlayLooping();
            sound_stop = false;
        ...
        {
            btn_login.BackgroundImage = Properties.Resources.登录游戏点燃;
            btn_login.BackgroundImageLayout = ImageLayout.Stretch;
        }

        private void btn_login_MouseLeave(object sender, EventArgs e)
        {
            btn_login.BackgroundImage = Properties.Resources.登录游戏正常;
            btn_login.BackgroundImageLayout = ImageLayout.Stretch;
        }
        ...
        private void btn_accRegisger_MouseEnter(object sender, EventArgs e)
        {
            btn_accRegisger.BackgroundImage = Properties.Resources.快速注册点燃;
            btn_accRegisger.BackgroundImageLayout = ImageLayout.Stretch;
        }

        private void btn_accRegisger_MouseLeave(object sender, EventArgs e)
        {
            btn_accRegisger.BackgroundImage = Properties.Resources.快速注册正常;
            btn_accRegisger.BackgroundImageLayout = ImageLayout.Stretch;
        }
        #endregion

        bool sound_stop = false;
